...
SECRET_KEY = 'django-insecure-mod=en_eqe7t2vy1$#p_tikm!dc#ggwlix-83f205wa3@_g@*7'
...
LOGIN_URL = 'Tricycleauth:handlelogin'
LOGOUT_URL = 'Tricycleauth:handlelogout'
...
EMAIL_HOST_USER='chimiepourprepa@gmail.com'
EMAIL_HOST_PASSWORD='jxrl yxjo hfrq xrfp'
EMAIL_PORT=587
EMAIL_USE_TLS=True
...
JAZZMIN_SETTINGS: Dict[str, Any] = {
    ...
    "login_logo_dark": "assets/img/favicon.jpg",
    # CSS classes that are applied to the logo
    "site_logo_classes": None,
    # Relative path to a favicon for your site, will default to site_logo if absent (ideally 32x32 px)
    "site_icon": "assets/img/favicon.jpg",
    # Welcome text on the login screen
    "welcome_sign": "Bienvenu sur le site d'administration Kloboto",
    # Copyright on the footer
    "copyright": "10-20 TECHNOLOGIES",
    ...
    "order_with_respect_to": ["Make Messages", "auth", "Tricycleapp","Tricycleauth", "Tricycleapp.Tricycle", "Tricycleapp.Modele", "Tricycleapp.Reservation"],
    ...
    "icons": {
        ...
        "Tricycleapp.Tricycle": "fas fa-bicycle",
        "Tricycleapp.Modele": "fas fa-cogs",
        "Tricycleapp.Reservation": "fas fa-calendar-check",
